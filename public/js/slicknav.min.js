...
!(function (e, t, n) {
    ...
    let arrowSymbol;
    arrowSymbol = "en" === language ? "&#9658;" : "ar" === language ? "&#9668;" : "&#9658;";
    var i = {
            label: "",
            duplicate: !0,
            duration: 200,
        ...
        e(p).each(function () {
            ...
            e(i.btn).keydown(function (t) {
                ...
                switch (n.keyCode) {
                    ...
                    case l_SPACE:
                    case l_DOWN:
                        t.preventDefault(), (n.keyCode === l_DOWN && e(i.btn).hasClass(o + "_open")) || i._menuToggle(), e(i.btn).next().find('[role="menuitem"]').first().focus();
                }
            }),
            ...
            i.mobileNav.on("keydown", '[role="menuitem"]', function (t) {
                ...
                switch ((t || event).keyCode) {
                    case l_DOWN:
                        ...
                        var a,
                            s,
                            r = (s = (a = e(t.target).parent().parent().children().children('[role="menuitem"]:visible')).index(t.target)) + 1,
                            c;
                        a.length <= r && (r = 0), (c = a.eq(r)).focus();
                        break;
                    case l_UP:
                        t.preventDefault();
                        var a,
                            s = (a = e(t.target).parent().parent().children().children('[role="menuitem"]:visible')).index(t.target),
                            c;
                        (c = a.eq(s - 1)).focus();
                        break;
                    case l_LEFT:
